...
import os,sys
folder = '/Users/rebekkabroyn/Documents/prosjektoppgave/Mic-tracks/'
for filename in os.listdir(folder):
       infilename = os.path.join(folder,filename)
       if not os.path.isfile(infilename): continue
       oldbase = os.path.splitext(filename)
       newname = infilename.replace('.tmp', '.mp4')
...
for (dirpath, dirnames, filenames) in os.walk('/Users/rebekkabroyn/Documents/prosjektoppgave/Mic-tracks/Aux'):
